...
In this project, I will learn about importing and using functions and creating
modules in Python. I will further practice using the builtin function
`dir()` and using command line arguments within Python programs accordingly.
